...
This folder contains the platform-specific `sharkd` assets bundled with the Electron app.
...
# Copy the binary
cp run/sharkd ../resources/sharkd/sharkd-x86_64-unknown-linux-gnu
```
...
During development, if no bundled binary is found, PacketPilot will fall back to using `sharkd` from your system PATH.
